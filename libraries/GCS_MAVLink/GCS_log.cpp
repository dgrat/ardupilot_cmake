 ...
 */
void GCS_handle::handle_log_message(mavlink_message_t *msg, DataFlash_Class &dataflash)
{
    switch (msg->msgid) {
...
/**
   handle all types of log download requests from the GCS
 */
void GCS_handle::handle_log_request_list(mavlink_message_t *msg, DataFlash_Class &dataflash)
{
 ...
 */
void GCS_handle::handle_log_request_data(mavlink_message_t *msg, DataFlash_Class &dataflash)
{
 ...
 */
void GCS_handle::handle_log_request_erase(mavlink_message_t *msg, DataFlash_Class &dataflash)
{
 ...
 */
void GCS_handle::handle_log_request_end(mavlink_message_t *msg, DataFlash_Class &dataflash)
{
 ...
 */
void GCS_handle::handle_log_send(DataFlash_Class &dataflash)
{
    if (_log_listing) {
        handle_log_send_listing(dataflash);
    }
...
/**
   trigger sending of log messages if there are some pending
 */
void GCS_handle::handle_log_send_listing(DataFlash_Class &dataflash) {
 ...
 */
bool GCS_handle::handle_log_send_data(DataFlash_Class &dataflash)
{
    uint16_t txspace = comm_get_txspace(chan);
